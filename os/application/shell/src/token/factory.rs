...
use crate::{
    ...
    token::{
        definition::{
            ...
            QUOTE_END_TOKEN_DEFINITION, QUOTE_START_TOKEN_DEFINITION, REDIRECT_IN_FILE_TOKEN_DEFINITION,
            REDIRECT_OUT_APPEND_TOKEN_DEFINITION, REDIRECT_OUT_TRUNCATE_TOKEN_DEFINITION, SEPARATOR_TOKEN_DEFINITION,
            TokenDefinition,
        },
...
impl TokenFactory {
    ...
    fn get_definition(kind: &TokenKind) -> &'static TokenDefinition {
        match *kind {
            ...
            TokenKind::RedirectInFile => &REDIRECT_IN_FILE_TOKEN_DEFINITION,
