...
pub fn read(application: Application) -> char {
    ...
    char::from_u32(syscall2(SystemCall::Read, application_addr, true as usize) as u32).unwrap()
}

pub fn try_read(application: Application) -> Option<char> {
    let application_addr = core::ptr::addr_of!(application) as usize;
    let character = syscall2(SystemCall::Read, application_addr, false as usize) as u32;
    match character {
        0 => None,
