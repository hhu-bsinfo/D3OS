...
use crate::tests::mlx4::rdma::session::RdmaSession;
use alloc::{vec, vec::Vec};
use core::ops::Range;
use crate::tests::mlx4::rdma::ALLOC_MEM;
use spin::Once;
use crate::{get_time_in_us, cpu};
    ...
    for batch_idx in (0..BATCHES) {
        ...
        for i in (0..ITERATIONS) {
            ...
            #[cfg(latency)]
            {
                ...
                data_collect_per_batch[batch_idx][i] = elapsed_time_us;

                cpu().local_irq_restore(flags);
            }
        ...
        #[cfg(throughput)]
        {
            ...
            let end_us = get_time_in_us();
            let elapsed_time_us = end_us - start_us;
            data_collect_per_batch[batch_idx][0] = elapsed_time_us;
